...
class alu_mul_sequence #(parameter WIDTH = 8) extends base_sequence #(WIDTH);
    
    `uvm_object_param_utils(alu_mul_sequence #(WIDTH))
    ...
    virtual task body();
        ...
        // MUL Opcode
        wr_seq.addr = 8'h0C; wr_seq.data = 8'h02; wr_seq.start(m_sequencer);
        ...
        `uvm_info("ALU_MUL_SEQ", $sformatf("Executed MUL: A=%0d, B=%0d, Result=%0d", operand_a, operand_b, rd_seq.read_data), UVM_MEDIUM)
    endtask
endclass